...
//             <div className="space-y-2">
//               <p className="text-gray-600 text-sm cursor-pointer hover:text-pink-600 transition-colors">Meditation</p>
//               <p className="text-gray-600 text-sm cursor-pointer hover:text-pink-600 transition-colors">Breathwork</p>
//               <p className="text-gray-600 text-sm cursor-pointer hover:text-pink-600 transition-colors">Mindfulness</p>
//             </div>
//           </div>
...
//                 Join Community
//               </Link>
//               <p className="text-gray-600 text-sm cursor-pointer hover:text-pink-600 transition-colors">Newsletter</p>
//               <p className="text-gray-600 text-sm cursor-pointer hover:text-pink-600 transition-colors">Support</p>
//             </div>
//           </div>
//         </div>
...
export function Footer() {
  return (
    ...
    >
      ...
      {/* Extra animated gradient overlay for glass effect */}
      <div className="absolute inset-0 bg-gradient-to-tr from-pink-200/20 via-purple-200/10 to-transparent opacity-60 animate-[pulse_6s_infinite_alternate] rounded-t-3xl pointer-events-none" />
    </footer>
  )
}
