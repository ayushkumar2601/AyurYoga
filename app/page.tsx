  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <main>
        ...
        {/* Animated Book a Yoga Tutor Section */}
        <section className="py-20 bg-gradient-to-b from-white/80 to-pink-50">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <ScrollReveal delay={100}>
                <div className="space-y-8">
                  <Sparkles className="h-12 w-12 text-pink-500 mx-auto animate-pulse" />
                  <h2 className="text-4xl lg:text-5xl font-serif font-bold text-gray-800">
                    Book a Yoga Tutor
                  </h2>
                  <p className="text-xl text-gray-600 leading-relaxed">
                    Elevate your practice with personalized guidance from an expert tutor. Start your journey to inner peace today!
                  </p>
                  <div className="flex justify-center">
                    <Link href="/tutor-dashboard">
                      <Button
                        size="lg"
                        className="bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white font-semibold px-8 py-4 text-lg rounded-full animate-bounce-slow"
                        onMouseEnter={() => setHover(true)}
                        onMouseLeave={() => setHover(false)}
                      >
