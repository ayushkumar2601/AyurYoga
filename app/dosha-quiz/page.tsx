...
const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      { text: "Dry, thin, prone to cracking", dosha: "vata", points: 3 },
      { text: "Warm, oily, prone to redness or acne", dosha: "pitta", points: 3 },
      { text: "Cool, soft, thick, and oily", dosha: "kapha", points: 3 },
    ],
  },
  {
    id: 10,
    question: "How do you react to physical exercise?",
    options: [
      { text: "Tire quickly, prefer short bursts of activity", dosha: "vata", points: 3 },
      { text: "Enjoy intense workouts, sweat a lot", dosha: "pitta", points: 3 },
      { text: "Can exercise for long periods, build endurance slowly", dosha: "kapha", points: 3 },
    ],
  },
  {
    id: 11,
    question: "What’s your typical mood or temperament?",
    options: [
      { text: "Changeable, enthusiastic, sometimes restless", dosha: "vata", points: 3 },
      { text: "Passionate, determined, occasionally intense", dosha: "pitta", points: 3 },
      { text: "Calm, steady, sometimes complacent", dosha: "kapha", points: 3 },
    ],
  },
  {
    id: 12,
    question: "How do you respond to new environments or changes?",
    options: [
      { text: "Feel excited but easily unsettled", dosha: "vata", points: 3 },
      { text: "Adapt well but prefer to lead or control", dosha: "pitta", points: 3 },
      { text: "Take time to adjust, prefer stability", dosha: "kapha", points: 3 },
    ],
  },
];
