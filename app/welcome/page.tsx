...
//             <p className="text-xl md:text-2xl text-slate-300 font-light">to your spiritual wellness journey</p>
//           </div>
...
//               </p>
//               <p className="text-sm text-slate-400 mt-4">- Ancient Wisdom</p>
//             </div>
//           </div>
...
//             </div>
//             <p className="text-sm text-slate-400 mt-4">Preparing your personalized experience...</p>
//           </div>
//         </div>
//       </div>
...
//           width: 40px;
//           height: 60px;
//           background: linear-gradient(45deg, rgba(20, 184, 166, 0.3), rgba(147, 51, 234, 0.3));
...
//           50% { filter: drop-shadow(0 0 40px rgba(147, 51, 234, 0.5)); }
//         }
